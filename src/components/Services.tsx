...
const Services: React.FC = () => {
  ...
  return <section id="services" className="py-20 md:py-24 bg-salon-cream">
      <div className="section-container">
        <div className="text-center mb-10 md:mb-12 px-4 md:px-0">
          ...
          <h2 ref={el => elementsRef.current[1] = el} className="animated-element text-3xl md:text-4xl font-serif font-medium mt-4 mb-5 md:mb-6 opacity-0">Vi tar hand om dig</h2>
          
          <p ref={el => elementsRef.current[2] = el} className="animated-element text-salon-dark/90 max-w-2xl mx-auto opacity-0 text-lg md:px-0 px-4">
        ...
        <div className="mt-14 md:mt-16 flex flex-col lg:flex-row items-center justify-center gap-6 transition-all">
