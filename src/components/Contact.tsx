...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 bg-gradient-to-b from-white to-salon-cream/50">
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Contact Info */}
          <div ref={el => elementsRef.current[3] = el} className="animated-element bg-salon-dark rounded-lg overflow-hidden shadow-xl order-2 md:order-1">
            <div className="p-8 text-white">
              <h3 className="text-2xl font-serif mb-6 text-salon-gold">Kontaktinformation</h3>
              
              <div className="space-y-6">
                <div>
                  <h4 className="font-serif text-lg mb-2 text-salon-gold">Adress</h4>
                ...
                <div>
                  <h4 className="font-serif text-lg mb-2 text-salon-gold">Kontakt</h4>
                  <p className="text-white/80">08-549 040 50</p>
                  <a href="mailto:salongmarialouis@gmail.com" className="text-white/80 hover:text-salon-gold transition-colors">
                    salongmarialouis@gmail.com
                  </a>
                </div>
                
                <div>
                  <h4 className="font-serif text-lg mb-2 text-salon-gold">Öppettider</h4>
                  <p className="text-white/80">
          ...
          <div className="order-1 md:order-2 space-y-8">
            ...
            <div ref={el => elementsRef.current[4] = el} className="animated-element bg-white rounded-lg shadow-xl p-8 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-serif mb-4 text-salon-dark relative z-10">Boka Online</h3>
            ...
            {/* Contact Form */}
            <div ref={el => elementsRef.current[5] = el} className="animated-element bg-white rounded-lg shadow-xl p-8">
              <h3 className="text-2xl font-serif mb-6 text-salon-dark">Skicka meddelande</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button 
                  type="submit" 
                  className="w-full py-3 px-6 bg-salon-gold text-white font-medium rounded hover:bg-salon-brown transition-all shadow-md hover:shadow-lg"
                >
                  Skicka meddelande
                </button>
              </form>
        ...
        <div className="mt-10 rounded-lg overflow-hidden shadow-xl h-[400px] animated-element" ref={el => elementsRef.current[6] = el}>
          <iframe
