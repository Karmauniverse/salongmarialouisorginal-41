...
const Contact: React.FC = () => {
  ...
  const InfoCard = ({ 
    ...
    <div className="flex flex-col items-center text-center mb-8 md:mb-0 group">
      <div className="w-14 h-14 rounded-full bg-salon-gold/10 flex items-center justify-center mb-3 transition-all duration-300 group-hover:bg-salon-gold/20">
        <Icon className="w-6 h-6 text-salon-gold transition-colors duration-300 group-hover:text-salon-brown" />
      </div>
      <h4 className="font-medium text-salon-dark mb-1">{title}</h4>
      <div className="text-salon-dark/80 text-sm leading-relaxed">{children}</div>
    </div>
  );
    ...
    <section id="contact" className="py-14 bg-gradient-to-b from-white to-salon-cream/30">
      <div className="section-container">
        ...
        <div 
          ...
          className="animated-element grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 items-start mb-16"
        >
          ...
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <a 
                ...
                className="block text-center px-6 py-3 border border-salon-gold text-salon-gold font-medium rounded-full hover:bg-salon-gold hover:text-white transition-all shadow-sm hover:shadow-md"
              >
                Boka Online
