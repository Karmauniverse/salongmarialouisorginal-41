              ...
              <div className="p-8 text-white space-y-8">
                ...
                <div className="pt-6 border-t border-white/10">
                  ...
                  <div className="flex space-x-4">
                    <a href="https://www.instagram.com/salongmarialouiis/" target="_blank" rel="noopener noreferrer" 
                       className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-salon-gold transition-all duration-300">
                    ...
                    <a href="https://www.facebook.com/profile.php?id=100063562662842" target="_blank" rel="noopener noreferrer"
                       className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-salon-gold transition-all duration-300">
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="order-1 md:order-2">
            <div ref={el => elementsRef.current[4] = el} className="animated-element bg-white rounded-lg shadow-xl p-8 relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                <a href="https://www.bokadirekt.se" target="_blank" rel="noopener noreferrer" 
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        className="border-salon-gold/20 focus-visible:ring-salon-gold" 
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      onChange={handleInputChange} 
                      className="border-salon-gold/20 focus-visible:ring-salon-gold min-h-[120px]" 
                      placeholder="Vad vill du boka tid för?" 
                      required 
                    />
                  </div>
                  ...
                  <button 
                    type="submit" 
                    className="w-full py-3 px-6 bg-salon-dark text-white font-medium rounded hover:bg-salon-brown transition-all shadow-md"
                  >
                    Skicka förfrågan
                  </button>
                </form>
