...
const Contact: React.FC = () => {
  ...
  return (
    <div
      id="contact"
      className="bg-gradient-to-b from-white to-salon-cream/50 py-24 md:py-32"
    >
      <div className="section-container bg-salon-cream rounded-2xl shadow-sm">
        <div className="text-center max-w-3xl mx-auto mb-14 md:mb-16">
          <div
            ref={(el) => (elementsRef.current[0] = el)}
            className="animated-element mb-4 opacity-0"
          >
          ...
          <h2
            ...
            className="animated-element text-3xl md:text-4xl font-serif font-medium mb-5 opacity-0"
          >
            Välkommen till oss
          </h2>
          ...
          <p
            ...
            className="animated-element text-salon-dark/80 max-w-2xl mx-auto opacity-0 font-lora text-lg px-4 md:px-0 leading-relaxed"
          >
            Hos oss är alla välkomna – stora som små, unga som gamla. Vi
            lyssnar, anpassar oss och strävar efter att göra din stund hos oss
            trygg, smidig och personlig.
            <br className="hidden md:block" />
            <span className="block mt-2">
              Vi värdesätter varje besök och möter dig med omtanke och respekt –
              oavsett vem du är.
            </span>
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-center px-4 md:px-8 py-6">
          ...
          <div
            ...
            className="animated-element opacity-0 flex flex-col gap-6"
          >
            ...
            {!isMobile && (
              <div className="grid grid-cols-3 gap-4 w-full">
                <div className="bg-salon-gold/5 p-4 rounded-lg text-center">
                  ...
                  <p className="text-sm font-medium text-salon-dark">
                    Flexibla tider
                  </p>
                </div>
                <div className="bg-salon-gold/5 p-4 rounded-lg text-center">
          ...
          <div
            ...
            className="animated-element opacity-0 flex flex-col items-center md:items-start justify-center space-y-8"
          >
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl border border-salon-gold/10 shadow-sm w-full">
              <div className="space-y-6">
                <div className="text-center md:text-left">
                  <h3 className="text-2xl font-serif mb-4 text-salon-dark">
                    Våra Behandlingar
                  </h3>
                  <p className="font-lora text-lg text-salon-dark mb-6 leading-relaxed">
                    Vill du veta mer om våra klippningar, färgningar eller
                    styling?
                  </p>

                  <a
                    href="#services"
                    className="inline-flex items-center gap-2 text-lg font-medium text-salon-gold hover:text-salon-brown transition-colors group"
                  >
                    <Scissors
                      size={18}
                      className="text-salon-gold transition-all duration-300 group-hover:rotate-12"
                    />
                ...
                <div className="flex flex-col items-center md:items-start space-y-3">
                  <span className="text-salon-dark/60 text-sm">
                    Ring oss direkt
                  </span>
                  <a
