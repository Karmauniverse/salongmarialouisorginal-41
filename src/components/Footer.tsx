      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-10 mb-16">
          ...
          <div className="flex flex-col items-start">
            <img src="/lovable-uploads/7f539d77-5c4f-417e-bc3b-e9a15c1628bf.png" alt="Maria Louis Logotyp" className="h-32 mb-4 object-scale-down" />
            <p className="text-white/60 text-sm mx-[14px] my-0">Sedan 2010 har vi levererat högkvalitativ hårservice
 i Hägersten – en prisbelönt salong med hjärta!</p>
          </div>
