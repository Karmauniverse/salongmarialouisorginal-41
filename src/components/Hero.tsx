      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <div ref={el => elementsRef.current[0] = el} className="animated-element mb-6">
            <span className="inline-block px-6 py-2 bg-salon-gold/20 text-salon-gold text-sm font-medium rounded-full border border-salon-gold/30">Salong</span>
          </div>
          ...
          <div ref={el => elementsRef.current[4] = el} className="animated-element flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://bokning.voady.se/marialouis/marialouisebarbershop/" target="_blank" rel="noopener noreferrer" className="px-8 py-3 border border-salon-gold text-white font-medium rounded-full hover:bg-salon-gold/30 transition-all text-center hover:border-white">
              Boka Tid
            </a>
          </div>
          ...
          {isMobile && (
            <div className="mt-4 animated-element">
              <a href="tel:+46701234567" className="inline-flex items-center px-5 py-2 border border-salon-gold/60 text-white rounded-full hover:bg-salon-gold/20 transition-all">
