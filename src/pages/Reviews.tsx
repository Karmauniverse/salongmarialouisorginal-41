...
const Reviews = () => {
  ...
  return <div className="min-h-screen bg-salon-cream">
      <Navbar />
      <section className="py-20 pt-32 bg-gradient-to-b from-white to-salon-cream/30">
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {reviews.map((review, index) => <div key={index} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              }).map((_, i) => <svg key={i} className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
