      ...
      >
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-5 text-gray-800 leading-relaxed font-lora">
            Med över 35 års samlad expertis erbjuder vi en plats där skönhet,
            omtanke och kvalitet möts. Här står du i fokus – oavsett om du
            kommer för en klippning, färg eller barbering.
          </p>
          <div className="mt-3">
            <a
              href="#about"
              className="italic text-base inline-flex items-center gap-1 text-salon-gold hover:text-salon-brown hover:underline transition-colors font-medium"
            >
              Läs mer om oss
              <svg
